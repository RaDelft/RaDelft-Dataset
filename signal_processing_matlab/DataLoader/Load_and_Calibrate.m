function [dataCube, numValidFrames] = Load_and_Calibrate(calObject, dataFolder, startFrame, endFrame)
...
for frameIdx = startFrame:endFrame
    ...
    adcData = read_ADC_bin_TDA2_separateFiles(fileNameStruct,frameIdx,numSamplePerChirp,numChirpPerLoop,nchirp_loops, numRXPerDevice, 1);
...
%       TXind = iTX;
    ...
    dataCube(:,:,:, frameIdx-1) = adcData(:,:,:);
    
end

% There is one useless frame at the beginning
numValidFrames = numValidFrames - 1;
